...
kUniverseType.addSuffixes(
  ...
  noMap(createSuffixType('quickSaveList', listType.toConcrete(stringType))),
  ...
  noMap(createSuffixType('craftList', listType.toConcrete(craftTemplateType))),
  noMap(createArgSuffixType(
    'switchVesselWatchers',
    uniqueSetType.toConcrete(delegateType),
  )),
