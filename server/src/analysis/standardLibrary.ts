...
const functionTypes: [string[], IFunctionType] = [
  ...
  [['add', 'alarm'], createFunctionType('addalarm', kacAlarmType, stringType, stringType, scalarType, stringType)],
  [['all', 'waypoints'], createFunctionType('allwaypoints', listType.toConcreteType(waypointType))],
  [['angle', 'axis'], createFunctionType('angleaxis', directionType, vectorType, scalarType)],
  [['angle', 'diff'], createFunctionType('anglediff', scalarType, scalarType, scalarType)],
  ...
  [['body', 'atmosphere'], createFunctionType('bodyatmosphere', bodyAtmosphereType, stringType)],
  [['build', 'list'], createFunctionType('buildlist', /* TODO Union */ scalarType, stringType)],
  ...
  [['copy', 'path'], createFunctionType('copypath', voidType, stringType, stringType)],
  [['cos'], createFunctionType('cos', scalarType)],
  [['create'], createFunctionType('create', volumeFileType, stringType)],
  [['create', 'dir'], createFunctionType('createdir', volumeDirectoryType, stringType)],
  [['debug', 'dump'], createFunctionType('debugdump', voidType)],
  [['debug', 'freeze', 'game'], createFunctionType('debugfreezegame', scalarType)],
  [['delete', 'alarm'], createFunctionType('deleteAlarm', booleanType, stringType)],
  [['delete', 'path'], createFunctionType('deletepath', voidType, stringType, stringType)],
  ...
  [['heading'], createFunctionType('heading', directionType, scalarType, scalarType)],
  [['highlight'], createFunctionType('highlight', highlightType, structureType, rgbaType)],
  [['hsv'], createFunctionType('hsv', hsvaType, scalarType, scalarType, scalarType)],
  [['hsva'], createFunctionType('hsva', hsvaType, scalarType, scalarType, scalarType, scalarType)],
  [['hudtext'], createFunctionType(
    'hudtext', voidType, stringType, integarType,
    integarType, rgbaType, booleanType)],
  [['latlng'], createFunctionType('latlng', geoCoordinatesType, scalarType, scalarType)],
  [['lex'], createVarFunctionType('lex', lexiconType, createVarType(structureType))],
  [['lexicon'], createVarFunctionType('lexicon', lexiconType, createVarType(structureType))],
  [['list'], createVarFunctionType('list', userListType, createVarType(structureType))],
  [['list', 'alarms'], createFunctionType('listAlarms', listType.toConcreteType(kacAlarmType), stringType)],
  [['ln'], createFunctionType('ln', scalarType, scalarType)],
  [['log10'], createFunctionType('log10', scalarType, scalarType)],
  [['log', 'file'], createFunctionType('logfile', voidType, stringType, stringType)],
  [['look', 'dir', 'up'], createFunctionType('lookdirup', directionType, vectorType, vectorType)],
  [['make', 'builtin', 'delegate'], createFunctionType('makebuiltindelegate', builtInDelegateType, stringType)],
  ...
  [['move', 'path'], createFunctionType('movepath', voidType, stringType, stringType)],
  [['node'], createFunctionType('node', nodeType, scalarType, scalarType, scalarType, scalarType)],
  [['note'], createFunctionType('note', noteType, scalarType, scalarType, scalarType, scalarType)],
  [['open'], createFunctionType('open', volumeItemType, stringType)],
  [['orbit', 'at'], createFunctionType('orbitat', orbitInfoType, orbitableType, timeSpanType)],
  [['path'], createFunctionType('path', pathType, stringType)],
  [['pid', 'loop'], createFunctionType(
    'pidloop', pidLoopType, scalarType,
    scalarType, scalarType, scalarType, scalarType)],
  [['position', 'at'], createFunctionType('positionat', vectorType, orbitableType, timeSpanType)],
  [['print'], createFunctionType('print', voidType, structureType)],
  [['print', 'at'], createFunctionType('printat', structureType, scalarType, scalarType)],
  [['print', 'list'], createFunctionType('printlist', voidType, stringType)],
  [['processor'], createFunctionType('processor', partType, /* TODO Union Type */ stringType)],
  [['profile', 'result'], createFunctionType('profileresult', voidType)],
  [['q'], createFunctionType('q', directionType, scalarType, scalarType, scalarType, scalarType)],
  [['queue'], createVarFunctionType(
    'queue', queueType.toConcreteType(structureType), createVarType(structureType))],
  [['r'], createFunctionType('r', directionType, scalarType, scalarType, scalarType)],
  [['random'], createFunctionType('random', scalarType)],
  [['range'], createFunctionType('range', rangeType, integarType, integarType, integarType)],
  [['read', 'json'], createFunctionType('readjson', serializableStructureType, stringType), // TODO Union Types
  [['reboot'], createFunctionType('reboot', voidType)],
  [['remove'], createFunctionType('remove', voidType, nodeType)],
  [['rgb'], createFunctionType('rgb', rgbaType, scalarType, scalarType, scalarType)],
  [['rgba'], createFunctionType('rgba', rgbaType, scalarType, scalarType, scalarType, scalarType)],
  [['rotate', 'from' 'to'], createFunctionType('rotatefromto', directionType, vectorType, vectorType)],
  [['round'], createFunctionType('round', scalarType, scalarType)],
  [['script', 'path'], createFunctionType('scriptpath', pathType)],
  [['select', 'auto' 'pilot', 'mode'], createFunctionType('selectautopilotmode', voidType, stringType)],
  [['shutdown'], createFunctionType('shutdown', voidType)],
  [['sin'], createFunctionType('sin', scalarType)],
  [['slide', 'note'], createFunctionType(
  ...
  [['toggle', 'fly', 'by', 'wire'], createFunctionType('toggleflybywire', voidType, stringType, booleanType)],
  [[], createFunctionType(
    'transfer', resourceTransferType,
    stringType, structureType, structureType, scalarType)],
  [['transfer', 'all'], createFunctionType(
  ...
  [['unique', 'set'], createVarFunctionType(
    'uniqueset', uniqueSetType.toConcreteType(structureType), createVarType(structureType))],
  [['v'], createFunctionType('v', vectorType, scalarType, scalarType, scalarType)],
  [['v', 'ang'], createFunctionType('vang', vectorType, vectorType, vectorType)],
  [['v', 'crs'], createFunctionType('vcrs', vectorType, vectorType, vectorType)],
  [['v', 'dot'], createFunctionType('vdot', vectorType, vectorType, vectorType)],
  [['vec', 'draw'], createFunctionType(
    'vecdraw', vectorRendererType, vectorType, vectorType, rgbaType,
    stringType, scalarType, booleanType, scalarType)],
  [['vec', 'draw', 'args'], createFunctionType(
    'vecdrawargs', vectorRendererType, vectorType, vectorType, rgbaType,
    stringType, scalarType, booleanType, scalarType)],
  [['vector', 'angle'], createFunctionType('vectorangle', scalarType, vectorType, vectorType)],
  [['vector', 'cross', 'product'], createFunctionType('vectorcrossproduct', vectorType, vectorType, vectorType)],
  [['vector', 'dot', 'product'], createFunctionType('vectordotproduct', vectorType, vectorType, vectorType)],
  [['vector', 'exclude'], createFunctionType('vectorexclude', vectorType, vectorType, vectorType)],
  [['velocity', 'at'], createFunctionType('velocityat', vectorType, orbitableType, timeSpanType)],
  ...
  // TODO Union Types
  [['write', 'json'], createFunctionType('writejson', volumeFileType, serializableStructureType, stringType)],
];
